...
def train_tq_model(model, num_meas_qubits, opt, loss, data_loader, 
                   epochs, print_freq=1, loss_window=50, 
                   use_test=False, return_train_losses=False, quantize=False,
    ...
    for epoch in range(epochs):
        ...
        for step, (x, y) in enumerate(data_loader):
            ...
            opt.step()
            if loss < best_loss:
                path=os.path.join(checkpoint_path, 'best.pt')
